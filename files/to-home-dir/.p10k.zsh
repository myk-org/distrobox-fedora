# Generated by Powerlevel10k configuration wizard on 2022-01-13 at 14:49 IST.
...
# unicode, 24h time, angled separators, sharp heads, flat tails, 2 lines, dotted,
# no frame, lightest-ornaments, compact, many icons, concise, transient_prompt,
# instant_prompt=off.
...
() {
  ...
  function my_git_formatter() {
    ...
    local       meta='%0F' # white foreground
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=000
